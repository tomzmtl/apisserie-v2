...
const Migration = () => {
  ...
  return (
    <div className="Migration">
      <Button variant="contained" onClick={handleClick} disabled={isComplete} sx={{ width: "100%" }}>
        {isLoading ? `Migrating ${completed}/${products.length}` : isComplete ? "Done" : "Migrate data"}
      </Button>
